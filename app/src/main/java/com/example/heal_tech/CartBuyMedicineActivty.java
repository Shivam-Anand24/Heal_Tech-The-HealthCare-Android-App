...
import com.example.heal_tech.model.Medicine;
...
public class CartBuyMedicineActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed2.setText(address);
        ed3.setText(contact);
        ed4.setText("Rating : " + fees + "/-");



        medicine.setName(fullname);
        medicine.setMedicalIssue(title);
        medicine.setAddress(address);
        medicine.setMobileNo(contact);
        medicine.setRating(fees);
        medicine.setU_id(mAuth.getUid());
        ...
        DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {
                ...
                medicine.setBooked_date(date_1);
                datePickerDialog.show();
            }
        };
    ...
    private void initTimePicker()
    {
        TimePickerDialog.OnTimeSetListener timeSetListener = new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int i, int i1) {
                ...
                medicine.setBooked_time(bookTime);
            }
        };
