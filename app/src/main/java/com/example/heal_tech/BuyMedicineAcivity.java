...
public class BuyMedicineAcivity extends AppCompatActivity {
    ...
    private String[][] packages =
            {
                    ...
                    {"Vitamin B Complex Capsules", "", "", "", "431"},

                    {"Inlife Vitamin E Wheat Germ Oil Capsule", "", "", "", "510"},

                    {"Dolo 650 Tablet", "", "", "", "230"},

                    {"Crocin 650 Advance Tablet", "", "", "", "20"},

                    {"Strepsils Medicated Lozenges for Sore Throat", "", "", "", "760"},
...

    {
        ...
        "Building and keeping the bones & teeth strong\n" + "Reducing Fatigue/stress and muscular pains\n" +
                ...
                "Delo 650 Tablet helps relieve pain and fever by blocking the release of certain chemical . \n" +
                ...
                "Reduces the risk of calcium deficiency, Rickets, and Osteoporosisin \n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGotoCart=findViewById(R.id.ButtonbuyMedicineGotoCart);

        btnGotoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BuyMedicineAcivity.this,CartBuyMedicineActivty.class));
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BuyMedicineAcivity.this,HomeActivity.class));
            }
        });

        list =new ArrayList();
        for(int i=0;i<package_details;i++) {
        ...
        sa=new SimpleAdapter(this,list,R.layout.multi_lines, new String[]
                ...
                new int[]{
                        R.id.line_a,R.id.line_b,R.id.line_c,R.id.line_d,R.id.line_e                        R.id.line_a,R.id.line_a,R.id.line_a,R.id.line_a,
